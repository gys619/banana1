/*
活动名称：LZ店铺抽奖
活动链接：https://lzkj-isv.isvjcloud.com/lzclient/12345/cjwx/common/entry.html?activityId=<活动id>
环境变量：RUSH_LZCLIENT // 活动id
                                            ...
                                            if (data.data.drawInfo) {
                                                switch (data.data.drawInfo.type) {
                                                    case 4: // 再来一次
                                                        ...
                                                        break;
                                                    case 6:
                                                        console.log(`🎉 ` + data.data.drawInfo.name + ' 🐶');
                                                        break;
                                                    case 7:
                                                    ...
                                                    case 13:
                                                        ...
                                                        break;
                                                    case 16:
                                                        console.log(`🎉 ` + data.data.drawInfo.priceInfo + ' 🧧');
                                                        break;
                                                    default:
                                                        if (data.data.drawInfo.name.includes("券")) {
                                                            console.log(`🗑️ 垃圾优惠券`);
                                                        } else {
