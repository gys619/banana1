/**
 明星小店
 cron 10 9,18 9-25 8 * https://raw.githubusercontent.com/11111115/JDHelp/main/jd_star_shop.js
 cron "10 9,18 9-25 8 *" https://raw.githubusercontent.com/11111115/JDHelp/main/jd_star_shop.js
 蚊子腿，欧皇可以中实物
 */
const $ = new Env('明星小店');
...
!(async () => {
    ...
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/11111115/JDHelp/main/starShop.json');}catch (e) {}
    if(res && res.length > 0){
