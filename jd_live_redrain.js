/*
"0 * 24 11 *" live_redrain1.js
*/
const $ = new Env('整点京豆雨');
let allMessage = '';
let bodyList = {
  '20': {
    url: 'https://api.m.jd.com/client.action?functionId=liveActivityV842&uuid=8888888&client=apple&clientVersion=9.4.4&st=1616761511931&sign=1c8a8ab69f27e2bb7b8539dfa5ec3a78&sv=100',
    body: 'body=%7B%22liveId%22:%223759184%22%7D'
  }
}
let ids = {
