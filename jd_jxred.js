/*
双十一无门槛红包
cron 0 10,12,20 * * * https://raw.githubusercontent.com/123/jd/main/scripts/jd_jxred.js
返利变量：FLCODE，默认给脚本作者返利，若需要返利给自己，请自己修改返利变量FLCODE；例：FLCODE="你的返利code"
* */
const $ = new Env('双11红包');
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
const notify = $.isNode() ? require('./sendNotify') : '';
const flCode = $.isNode() ? (process.env.FLCODE ? process.env.FLCODE : 'yKYuOcp'):'yKYuOcp';
let cookiesArr = [];
if ($.isNode()) {
