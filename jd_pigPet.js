...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/222222/updateTeam/master/shareCodes/pig.json')
  if (!res) {
    ...
    await $.wait(2000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/222222/updateTeam@master/shareCodes/pig.json')
  }
