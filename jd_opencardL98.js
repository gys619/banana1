...
!(async () => {
  ...
  authorCodeList = await getAuthorCodeList('https://gitee.com/444444521/JD-Scripts/raw/master/shareCodes/opencard98.json')
  ...
  console.log(`入口:\nhttps://lzdz1-isv.isvjcloud.com/dingzhi/womenWear/union/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`)
  ...
  switch (type) {
    case 'isvObfuscator':
      ...
      case 'activityContent':
        url = `${domain}/dingzhi/womenWear/union/activityContent`;
      ...
      case 'drawContent':
        ...
        break;
      case 'checkOpenCard':
        url = `${domain}/dingzhi/womenWear/union/initOpenCard`;
      ...
      case 'info':
        ...
        break;
      case 'startDraw':
        url = `${domain}/dingzhi/womenWear/union/draw`;
      ...
      case 'getShareRecord':
        ...
        break;
      case 'getRule':
        url = `${domain}/dingzhi/womenWear/union/getRule`;
        body = `activityId=${$.activityId}`
        break;
      case '抽奖':
        url = `${domain}/dingzhi/womenWear/union/draw`;
...
function getPostRequest(url, body, method="POST") {
  ...
  if(url.indexOf('https://lzdz1-isv.isvjcloud.com') > -1){
    headers["Referer"] = `https://lzdz1-isv.isvjcloud.com/dingzhi/womenWear/union/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
...
function getCk() {
  return new Promise(resolve => {
    let get = {
      url:`https://lzdz1-isv.isvjcloud.com/dingzhi/womenWear/union/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
