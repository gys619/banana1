...
[task_local]
#京东评价
37 15 * * * https://raw.githubusercontent.com/444444/JDJB/main/jd_evaluation.js, tag=京东评价, enabled=true

================Loon==============
[Script]
cron "37 15 * * *" script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_evaluation.js,tag=京东评价

===============Surge=================
京东评价 = type=cron,cronexp="37 15 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_evaluation.js

============小火箭=========
京东评价 = type=cron,script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_evaluation.js, cronexpr="37 15 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东评价');
    ...
    let data = {
        "0": {
            ...
            "中间": [
                ...
                "$  真是太好用了，真是个宝贝，难忘的宝贝!!",
                "$  短短几天的体验，令人一生难忘",
                "简直太棒了，刚收到货就迫不及待的拆开了用了，非常棒手感很不错，推荐使用！",
                "$  用了这么久了，它长的真是太可爱了",
                " 货到了 $感觉非常棒 物价所值 老铁，没毛病 感觉一级棒 值得入手的东西 就是这个feel 老铁 快下单吧",
                "这可真是个小宝贝！",
                "$非常好，价格便宜关键是东西好，买了好多次这次买的质量和功能各方面都非常好，大爱，强烈给给我兄弟推荐",
                "五星好评，安排上，太好用拉！！！"
            ],
            "结束": [
                "推荐大家来尝试",
