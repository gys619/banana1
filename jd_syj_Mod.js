...
function userSignIn() {
    return new Promise(resolve => {
        const body = {
            "activityId": "ccd8067defcd4787871b7f0c96fcbf5c",
            "inviterId": "",
            "channel": "MiniProgram"
        };
...
function pg_channel_page_data() {
    return new Promise(resolve => {
        const body = {
            "paramData": {
                "token": "3b9f3e0d-7a67-4be3-a05f-9b076cb8ed6a"
            }
        };
                        ...
                        if (data['success']) {
                            if (data['data'] && data['data']['floorInfoList']) {
                                ...
                                if (floorInfo.hasOwnProperty('token') && floorInfo['floorData'].hasOwnProperty('userActivityInfo')) {
                                    ...
                                    } = floorInfo['floorData']['userActivityInfo'];
