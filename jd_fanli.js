...
[task_local]
#京东饭粒
38 5,13,17 * * * https://raw.githubusercontent.com/444444/JDJB/main/jd_fanli.js, tag=京东饭粒, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true
================Loon==============
[Script]
cron "38 5,13,17 * * *" script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_fanli.js,tag=京东饭粒
===============Surge=================
京东饭粒 = type=cron,cronexp="38 5,13,17 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_fanli.js
============小火箭=========
京东饭粒 = type=cron,script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_fanli.js, cronexpr="38 5,13,17 * * *", timeout=3600, enable=true
 */
...
function saveTaskRecord(ck, taskId, businessId, taskType) {
    let opt = {
        ...
        headers: {
            ...
            "User-Agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 15_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 JDFanli/2.0.20 jd.fanli/2.0.20',
            // "Sec-Fetch-Mode": "cors",
