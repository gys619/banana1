...
第一个CK失效会退出脚本
————————————————
入口：[ 3.21-3.27 春日风尚 入会焕新 ]

请求太频繁会被黑ip
过10分钟再执行

cron:55 3,16 21-27 3 *
============Quantumultx===============
[task_local]
#3.21-3.27 春日风尚 入会焕新
...
!(async () => {
  ...
  authorCodeList = await getAuthorCodeList('https://gitee.com/444444521/JD-Scripts/raw/master/shareCodes/opencard99.json')
