/*
种豆得豆 脚本更新地址：https://raw.githubusercontent.com/123/sync/jd_scripts/jd_plantBean.js
更新时间：2021-04-9
...
=====================================Quantumult X=================================
[task_local]
20 8-21/2 * * * https://raw.githubusercontent.com/123/sync/jd_scripts/jd_plantBean.js, tag=种豆得豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdzd.png, enabled=true

=====================================Loon================================
[Script]
cron "20 8-21/2 * * *" script-path=https://raw.githubusercontent.com/123/sync/jd_scripts/jd_plantBean.js,tag=京东种豆得豆

======================================Surge==========================
京东种豆得豆 = type=cron,cronexp="20 8-21/2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/123/sync/jd_scripts/jd_plantBean.js

====================================小火箭=============================
京东种豆得豆 = type=cron,script-path=https://raw.githubusercontent.com/123/sync/jd_scripts/jd_plantBean.js, cronexpr="20 8-21/2 * * *", timeout=3600, enable=true
...
async function jdPlantBean() {
  try {
    ...
    if ($.plantBeanIndexResult && $.plantBeanIndexResult.code === '0' && $.plantBeanIndexResult.data) {
      ...
      // 报告运行次数
      $.get({
        url: `https://123/api/runTimes?activityId=bean&sharecode=${$.myPlantUuid}`,
        timeout: 10000
      }, (err, resp, data) => {
        if (err) {
...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({url: `https://123/api/bean/${randomCount}`, timeout: 10000}, (err, resp, data) => {
      try {
        if (err) {
...
function requireConfig() {
  return new Promise(resolve => {
    ...
    const jdPlantBeanShareCodes = $.isNode() ? require('./jdPlantBeanShareCodes2.js') : '';
