...
[task_local]
#京东宠汪汪
15 0-23/2 * * * https://raw.githubusercontent.com/123/sync/jd_scripts/jd_joy.js, tag=京东宠汪汪, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true

============Loon===========
[Script]
cron "15 0-23/2 * * *" script-path=https://raw.githubusercontent.com/123/sync/jd_scripts/jd_joy.js,tag=京东宠汪汪

============Surge==========
[Script]
京东宠汪汪 = type=cron,cronexp="15 0-23/2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/123/sync/jd_scripts/jd_joy.js

===============小火箭==========
京东宠汪汪 = type=cron,script-path=https://raw.githubusercontent.com/123/sync/jd_scripts/jd_joy.js, cronexpr="15 0-23/2 * * *", timeout=3600, enable=true
*/
const $ = new Env('宠汪汪');
