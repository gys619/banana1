...
[task_local]
#京喜财富岛合成月饼
10 6,13,23 * * * https://raw.githubusercontent.com/222222/sync/jd_scripts/jd_cfd_mooncake.js, tag=京喜财富岛合成月饼, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "10 6,13,23 * * *" script-path=https://raw.githubusercontent.com/222222/sync/jd_scripts/jd_cfd_mooncake.js,tag=京喜财富岛合成月饼

===============Surge=================
京喜财富岛合成月饼 = type=cron,cronexp="10 6,13,23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/222222/sync/jd_scripts/jd_cfd_mooncake.js

============小火箭=========
京喜财富岛合成月饼 = type=cron,script-path=https://raw.githubusercontent.com/222222/sync/jd_scripts/jd_cfd_mooncake.js, cronexpr="10 6,13,23 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  let res2 = await getAuthorShareCode('https://raw.githubusercontent.com/888888/updateTeam/main/shareCodes/cfd.json')
  if (!res2) {
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://raw.fastgit.org/888888/updateTeam/main/shareCodes/cfd.json')
  }
