...
!(async () => {
    ...
    // authorCodeList = await getAuthorCodeList('https://gitee.com/fatelight/123/raw/master/123/lzdz2_bw.json')
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            $.activityId = 'cfc218d9250d445a870b3c18b58b5475'
            $.activityShopId = '1000015026'
            $.activityUrl = `https://lzdz1-isv.isvjcloud.com/dingzhi/fashion/recruit/activity/${$.authorNum}?activityId=${$.activityId}&shareUuid=${encodeURIComponent($.authorCode)}&adsource=null&shareuserid4minipg=null&shopid=${$.activityShopId}&lng=00.000000&lat=00.000000&sid=&un_area=`
            await rush();
            await $.wait(1000)
