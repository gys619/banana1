...
[task_local]
#预售福利机
5 0,2 * * * https://raw.githubusercontent.com/123/sync/jd_scripts/jd_ys.js, tag=预售福利机, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "5 0,2 * * *" script-path=https://raw.githubusercontent.com/123/sync/jd_scripts/jd_ys.js,tag=预售福利机

===============Surge=================
预售福利机 = type=cron,cronexp="5 0,2 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/123/sync/jd_scripts/jd_ys.js

============小火箭=========
预售福利机 = type=cron,script-path=https://raw.githubusercontent.com/123/sync/jd_scripts/jd_ys.js, cronexpr="5 0,2 * * *", timeout=3600, enable=true
 */
const $ = new Env('预售福利机');
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/123/updateTeam/master/shareCodes/ys.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/123/updateTeam@master/shareCodes/ys.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/123/updateTeam@master/shareCodes/ys.json')
  }
