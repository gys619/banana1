...
[task_local]
#1.15～1.22 飞鹤大牌秒杀日
11 6 15-22 1 * jd_opencardL49.js, tag=1.15～1.22 飞鹤大牌秒杀日, enabled=true

*/

const $ = new Env('1.15～1.22 飞鹤大牌秒杀日');
  ...
  switch (type) {
    case 'isvObfuscator':
      ...
      case 'activityContent':
        url = `${domain}/dingzhi/flyCrane/collect/activityContent`;
      ...
      case 'drawContent':
        ...
        break;
      case 'checkOpenCard':
        url = `${domain}/dingzhi/flyCrane/collect/initOpenCard`;
      ...
      case 'startDraw':
        ...
        break;
      case 'followShop':
        url = `${domain}/dingzhi/flyCrane/collect/saveTask`;
      ...
      case 'getShareRecord':
        ...
        break;
      case 'getRule':
        url = `${domain}/dingzhi/flyCrane/collect/getRule`;
        body = `activityId=${$.activityId}`
        break;
      case '抽奖':
        url = `${domain}/dingzhi/flyCrane/collect/startDraw`;
...
function getPostRequest(url, body, method="POST") {
  ...
  if(url.indexOf('https://lzdz1-isv.isvjcloud.com') > -1){
    headers["Referer"] = `https://lzdz1-isv.isvjcloud.com/dingzhi/flyCrane/collect/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`
...
function getCk() {
  return new Promise(resolve => {
    let get = {
      url:`https://lzdz1-isv.isvjcloud.com/dingzhi/flyCrane/collect/activity?activityId=${$.activityId}&shareUuid=${$.shareUuid}`,
