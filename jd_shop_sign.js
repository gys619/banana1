...
[task_local]
#店铺签到
0 0 * * * https://raw.githubusercontent.com/123/JavaScript/master/Task/jd_shop_sign.js, tag=店铺签到, enabled=true
===========Loon============
[Script]
cron "0 0 * * *" script-path=https://raw.githubusercontent.com/123/JavaScript/master/Task/jd_shop_sign.js,tag=店铺签到
============Surge=============
店铺签到 = type=cron,cronexp="0 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/123/JavaScript/master/Task/jd_shop_sign.js
===========小火箭========
店铺签到 = type=cron,script-path=https://raw.githubusercontent.com/123/JavaScript/master/Task/jd_shop_sign.jss, cronexpr="0 0 * * *", timeout=3600, enable=true
*/
const $ = new Env('店铺签到');
