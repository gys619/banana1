...
!(async () => {
	console.log("【入口：https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity?activityId=4c7a504f30d7d2e0f73d84823ef84066】");
    $.getAuthorCodeListerr = false
    if (!cookiesArr[0]) {
        $.msg($.name, '【提示】请先获取京东账号一cookie\n直接使用NobyDa的京东签到获取', 'https://bean.m.jd.com/bean/signIndex.action', { "open-url": "https://bean.m.jd.com/bean/signIndex.action" });
        return;
    }
    authorCodeList = await getAuthorCodeList('https://gitee.com/444444521/JD-Scripts/raw/master/shareCodes/opencard103.json')
