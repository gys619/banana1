...
let cookiesArr = [], cookie = '', status=0;
let packetId = '';
...
!(async () => {
  ...
  if (packetId.length==0) packetId = codes.tt;
...
function getCode(url='https://raw.githubusercontent.com/11111115/params/main/codes.json') {
  return new Promise(async resolve => {
    const options = {
