	...
	try{
		...
		if(_0x22c107.allOpenCard==false){
			...
			for(o of _0x22c107.openList){
				...
				if((o.status==0)||(o.openStatus==false)){
					...
					await _0x5002d5();
					for(let _0x3f6587=0;_0x3f6587<Array(5).length;_0x3f6587++){
		...
		if(_0x22c107.addCart){
			...
			if(guaopencard_addSku+''=='true'){
				...
				let _0x1fc5f8=[];
				if(_0x4334f9){
					_0x1fc5f8=await _0x4334f9.clean(_0x27f181,'https://jd.11111118/jdcleancatr_21102717','');
				...
				if(_0x4334f9&&(_0x1fc5f8!==false)){
					await _0x4334f9.clean(_0x27f181,'https://jd.11111118/jdcleancatr_21102717',_0x1fc5f8||[]);
				}
			}else{
