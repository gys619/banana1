...
[task_local]
#京东领红包
0 0,12 * * * https://raw.githubusercontent.com/444444/JDJB/main/jd_red.js, tag=京东领红包, enabled=true

================Loon==============
[Script]
cron "0 0,12 * * *" script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_red.js,tag=京东领红包

===============Surge=================
京东领红包 = type=cron,cronexp="0 0,12 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_red.js

============小火箭=========
京东领红包 = type=cron,script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_red.js, cronexpr="0 0,12 * * *", timeout=3600, enable=true
    ...
    $.post(options, async (err, resp, data) => {
      try {
        if (err) {
          ...
          if (data) {
            if ($.code === "nd5q7cl" || $.code === "nwhtDMI" || $.code === "nKmhVTA") {
